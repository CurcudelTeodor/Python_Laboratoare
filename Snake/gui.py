...
This module provides functions for creating a game window with specified settings.

Functions:
    create_game_window(settings)
        Creates a game window with the specified settings.
...
def create_game_window(settings):
    ...
    Returns:
        Tk, Canvas, Label: The Tkinter window, canvas, and score label.
    """
...
def center_window(window):
    ...
    Parameters:
        window (Tk): The Tkinter window to be centered.
    """
